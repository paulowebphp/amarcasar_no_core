            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Compra de Plano</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        ...
                        <div class="body-title">parabéns por adquirir seu plano no Amar Casar</div>
                        <div class="body-title">esperamos que goste da experiência</div>
                        ...
                        <table class="body-text">
                          ...
                          <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row"></th>
                                    <th style="min-width: 222px;"><?php echo htmlspecialchars( $plan["desplan"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                                    <th><?php if( $plan["inperiod"] > 1 ){ ?> <?php echo htmlspecialchars( $plan["inperiod"], ENT_COMPAT, 'UTF-8', FALSE ); ?> meses <?php }else{ ?> <?php echo htmlspecialchars( $plan["inperiod"], ENT_COMPAT, 'UTF-8', FALSE ); ?> mês <?php } ?></th>
                                    <th>R$ <?php echo formatPrice($plan["vlsaleprice"]); ?></th>
                                    
                                    <th><?php echo formatDate($plan["dtbegin"]); ?></th>
                                    <td><?php echo formatDate($plan["dtend"]); ?></td>
