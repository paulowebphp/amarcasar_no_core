        ...
        <div class="row">                
            ...
            <div class="col-md-9">
                    ...
                    <form method="post" action="/dashboard/mensagens/<?php echo htmlspecialchars( $message["idmessage"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                        ...
                        <input type="text" class="form-control" id="desname" name="desname" placeholder="Digite o nome aqui" value="<?php echo htmlspecialchars( $message["desname"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" disabled>
                        </div>
