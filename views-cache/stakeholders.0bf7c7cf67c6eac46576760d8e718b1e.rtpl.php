        ...
        <div class="container">
            ...
            <?php if( $nrtotal == 0 ){ ?>
                ...
                <div class="alert alert-info text-center" role="alert">
                    <h1>Ainda não há fornecedores cadastrados</h1>
                </div>
            <?php }else{ ?>
                                ...
                                <div class="card-wrapper">
                                    ...
                                    <div class="card-event">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <h4><?php echo htmlspecialchars( $value1["desstakeholder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h4>
                                        ...
                                        <div class="card-details">
                                            ...
                                            <div class="row section-row">
                                                ...
                                                <div class="col-md-4 box-column">
                                                    ...
                                                    <hr>
                                                    <div class="under-title">Categoria</div>
                                            ...
                                            <div class="row section-row">
                                                ...
                                                <div class="col-md-6 box-column">
                                                    ...
                                                    <hr>
                                                    <div class="under-title">E-mail</div>
