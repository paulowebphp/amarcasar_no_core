            ...
            <tr>
              <td>
                ...
                <table id="email-box" width="100%" align="left" border="0" cellspacing="2" cellpadding="15 0">
                  ...
                  <tr>
                    <td colspan="3">
                      Vocês receberam uma nova mensgem no <strong>Amar Casar</strong>. Confiram os dados abaixo:
                    </td>
                  </tr>
                  <tr>
                    <td colspan="3"></td>
                  ...
                  <tr>
                    <td colspan="3">
                      Faça login no <strong>Amar Casar </strong>para gerenciar suas mensagens  
                    </td>
                  </tr>
                  <!-- horizontal gap -->
                  <tr>
