						...
						<tr>
							<td>
								...
								<table id="email-box" width="100%" align="left" border="0" cellspacing="2" cellpadding="15 0">
									...
									<tr>
										<td colspan="3">
											<strong><?php echo htmlspecialchars( $rsvp["desguest"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> confirmou presença no seu casamento. Confiram os dados abaixo:
										</td>
									</tr>
									...
									<tr>
										<td colspan="3">
											Faça login no <strong>Amar Casar </strong>para gerenciar suas confirmações de presença	
										</td>
									</tr>
									<!-- horizontal gap -->
									<tr>
