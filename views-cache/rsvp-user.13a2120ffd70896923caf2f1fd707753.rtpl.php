                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Olá <?php echo htmlspecialchars( $user["desperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?>,</div>
                        <div class="body-title"><?php echo htmlspecialchars( $rsvp["desguest"], ENT_COMPAT, 'UTF-8', FALSE ); ?></div>
                        <div class="body-title">você confirmou presença no seu casamento</div>
                        ...
                        <table class="body-text">
                          ...
                          <tbody>
                              <tr>
                                  <th scope="row"></th>
                                  <td><?php echo htmlspecialchars( $rsvp["desguest"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                  <td><?php if( $rsvp["inadultsconfirmed"] > 0 ){ ?><?php echo htmlspecialchars( $rsvp["inadultsconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php }else{ ?>0<?php } ?> / <?php echo htmlspecialchars( $rsvp["inmaxadults"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                  <td><?php if( $rsvp["inchildrenconfirmed"] > 0 ){ ?><?php echo htmlspecialchars( $rsvp["inchildrenconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php }else{ ?>0<?php } ?> / <?php echo htmlspecialchars( $rsvp["inmaxchildren"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                  <td><?php echo htmlspecialchars( $rsvp["nrphone"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                  <td><?php echo htmlspecialchars( $rsvp["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                  <td><?php echo htmlspecialchars( $rsvp["inconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                  <td><?php echo htmlspecialchars( $rsvp["desguestaccompanies"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>

                                  <td><?php echo htmlspecialchars( $rsvp["dtconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
