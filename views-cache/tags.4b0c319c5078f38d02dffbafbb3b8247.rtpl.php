                            ...
                            <div style="margin: 5%;" class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <ul style="list-style: none">
                                        ...
                                        <li style="max-width: 200px; float:left; margin: 5px 5px;"><a target="_blank" href="/res/dashboard/papelaria/gold/tag/<?php echo htmlspecialchars( $value1["tag"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" ><img src="/res/dashboard/papelaria/gold/<?php echo htmlspecialchars( $value1["thumb"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
