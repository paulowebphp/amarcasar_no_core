            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Mensagem Enviada!</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Olá <?php echo htmlspecialchars( $message["desmessage"], ENT_COMPAT, 'UTF-8', FALSE ); ?>,</div>
                        <div class="body-title">você enviou mensagem para o site de casamento de</div>
                        ...
                        <table class="body-text">
                          ...
                          <tbody>
                              <tr>
                                  <th scope="row"><?php echo htmlspecialchars( $message["dtregister"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                                  <td><?php echo htmlspecialchars( $message["desmessage"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                  <td><?php echo htmlspecialchars( $message["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                  <td><?php echo htmlspecialchars( $message["desdescription"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
