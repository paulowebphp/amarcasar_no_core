            ...
            <tr>
              <td>
                ...
                <table id="email-box" width="100%" align="left" border="0" cellspacing="2" cellpadding="15 0">
                  ...
                  <tr>
                    <td colspan="3">
                      <strong>Olá, <?php echo htmlspecialchars( $message["desmessage"], ENT_COMPAT, 'UTF-8', FALSE ); ?>!</strong>
                    </td>
                  </tr>
                  <!-- horizontal gap -->
                  ...
                  <tr>
                    <td colspan="3">
                      Sua mensagem para <strong><?php echo htmlspecialchars( $user["desperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?> e <?php echo htmlspecialchars( $consort["desconsort"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </strong> foi enviada!. Confira os dados abaixo:
                    </td>
                  </tr>
                  <tr>
                    <td colspan="3"></td>
                  ...
                  <tr>
                    ...
                    <td colspan="2" align="left" class="column2">
                      <?php echo htmlspecialchars( $message["desmessage"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" class="column1">
                    ...
                    <td colspan="2" align="left" class="column2">
                      <?php echo htmlspecialchars( $message["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" class="column1">
                    ...
                    <td colspan="2" align="left" class="column2">
                      <?php echo htmlspecialchars( $message["desdescription"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                    </td>
                  </tr>
                  <tr>  
                    <td align="left" class="column1">
                    ...
                    <td colspan="2" align="left" class="column2">
                      <?php echo htmlspecialchars( $message["dtregister"], ENT_COMPAT, 'UTF-8', FALSE ); ?> 
                    </td>
                  </tr>
                  <!-- horizontal gap -->
                  <tr>
