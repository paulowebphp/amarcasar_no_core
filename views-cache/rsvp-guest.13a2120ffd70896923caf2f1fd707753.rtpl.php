            ...
            <tr>
              <td>
                ...
                <table id="email-box" width="100%" align="left" border="0" cellspacing="2" cellpadding="15 0">
                  ...
                  <tr>
                    <td colspan="3">
                      <strong>Olá, <?php echo htmlspecialchars( $rsvp["desguest"], ENT_COMPAT, 'UTF-8', FALSE ); ?>!</strong>
                  ...
                  <tr>
                    <td colspan="3">
                       Muito obrigado! Você confirmou presença no casamento de <strong><?php echo htmlspecialchars( $user["desperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?> e <?php echo htmlspecialchars( $consort["desconsort"], ENT_COMPAT, 'UTF-8', FALSE ); ?>!</strong>
                    </td>
                  </tr>
                  ...
                  <tr>  
                    ...
                    <td colspan="2" align="left" class="column2">
                      <?php echo htmlspecialchars( $rsvp["dtconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?> 
                    </td>
                  </tr>
                  <tr>
                    <td align="left" class="column1">
                    ...
                    <td colspan="2" align="left" class="column2">
                      <?php echo htmlspecialchars( $rsvp["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" class="column1">
                    ...
                    <td colspan="2" align="left" class="column2">
                      <?php if( $rsvp["inadultsconfirmed"] > 0 ){ ?><?php echo htmlspecialchars( $rsvp["inadultsconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?> em <?php echo htmlspecialchars( $rsvp["inmaxadults"], ENT_COMPAT, 'UTF-8', FALSE ); ?> Permitidos<?php }else{ ?>0<?php } ?>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" class="column1">
                    ...
                    <td colspan="2" align="left" class="column2">
                      <?php if( $rsvp["inchildrenconfirmed"] > 0 ){ ?><?php echo htmlspecialchars( $rsvp["inchildrenconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?> em <?php echo htmlspecialchars( $rsvp["inmaxchildren"], ENT_COMPAT, 'UTF-8', FALSE ); ?> Permitidos<?php }else{ ?>0<?php } ?>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" class="column1">
                    ...
                    <td colspan="2" align="left" class="column2"> 
                      <?php echo htmlspecialchars( $rsvp["desguestaccompanies"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                    </td>
                  </tr>
                  <!-- horizontal gap -->
                  <tr>
                  ...
                  <tr>
                    <td colspan="3">
                      Busque o nome do casal no <strong>Amar Casar</strong> para presenteá-los e encantar-se com histórias, fotos, vídeos e muito mais!  
                    </td>
                  </tr>
                  <!-- horizontal gap -->
                  <tr>
