                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:222px;">
                                <a class="btn btn-default" href="/:desurl/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/continuar" role="button">Adicionar ao Carrinho</a>
                                <a class="btn btn-warning" href="/:desurl/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/adicionar" role="button">Comprar</a>
                            </td>
                        </tr>
                        <?php }else{ ?>
