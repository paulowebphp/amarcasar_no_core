                                ...
                                <div class="card-wrapper">
                                    ...
                                    <div class="card-event">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <h4><?php echo htmlspecialchars( $value1["desevent"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h4>
                                        ...
                                        <div class="card-details">
                                            ...
                                            <div class="row section-big-column section-row">
                                            ...
                                            <div class="row section-row">
                                                ...
                                                <div class="col-md-6 box-column">
                                                    <span><?php echo htmlspecialchars( $value1["desaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["desnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <?php echo htmlspecialchars( $value1["desdistrict"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php echo htmlspecialchars( $value1["descity"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, <?php echo htmlspecialchars( $value1["desstate"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                                                    <hr>
                                                ...
                                                <div class="col-md-3 box-column">
                                                    ...
                                                    <hr>
                                                    <div class="under-title">Ponto de Referência</div>
